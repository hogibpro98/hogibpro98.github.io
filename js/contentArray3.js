const contentArray3 = [
  {
    ...
    text: `
        ...
        W: A dog isn’t a toy that you play with for awhile. He will be part of our life for the next 10 or 20 years. He is a living creature.<br>
  ...
  },
  {
    ...
    text: `
      <p>Elephants are interesting. They are intelligent.
      ...
      man, even after so many years.</p>
      <p>Elephants help each other, too. Elephants use
      ...
      food. The elephants cooperate to help each other.<p>
      `,
  ...
  },
  {
    ...
    to seep into the garden.<br>
    G : I usually don’t have problems with ants, and I
    don’t use any chemicals.<br>
    ...
    birthday party. Would you mind helping me?<br>
  ...
  },
  {
    ...
    text: `
    <p>My best friend Katy lives near a beautiful
    ...
    were caught in the spill.</p>
    <p>When we arrived at the beach that day, the
    ...
    worked very hard that day to restore the beach.</p>
    <p>Once the oil was removed, the birds that had
  ...
  },
  {
    ...
    text: `
    <p>The Amazon is an amazing river. It is unique
    ...
    has many small rivers that supply it with water.</p>
    <p>It is the widest river in the world. The river
    ...
    water than any other river in the world.</p>
    <p>The Amazon River is also home to many animals.
  ...
  },
  {
    ...
    library and look at some books.<br>
    ...
    books first and then search for more information.<br>
  ...
  },
  {
    ...
    text: `
    <p>I have been interested in robots for as long as
    ...
    robot and these are what we use.</p>
    <p>The highlight of the year for us is the annual
    ...
    have a really good chance of winning.</p>
    <p>Our robot is about 30 centimeters high. It
    ...
    hope this will be my lucky year.</p>
      `,
  ...
  },
  {
    ...
    You know, not every area is wheelchair-accessible.<br>
    W: True. However, I’ve read that there are lots of
    strange people online who are dangerous.<br>
    ...
    the lag time or delay in the system.<br>
  ...
  },
  {
    ...
    text: `
    <p>One of the greatest achievements in the
    ...
    first prize was given in 1901.</p>
    <p>Each prize has three parts: a diploma, a gold
    ...
    1901, over 750 people have won the Nobel Prize.</p>
      `,
  ...
  },
  {
    ...
    text: `
    <p>What makes a painting a great work of art?
    ...
    great painting has a special element in it.</p>
    <p>Sometimes, a painter’s special element is the
    ...
    feelings about war.</p>
    <p>Other times, the element is a memory or feeling.
    ...
    about the woman in the painting.</p>
    <p>Which element is the most important? Is it
    the skill of the artist or the feelings of the person
    looking at the painting? Whatever the case, a
    painting that grabs people’s emotions is popular. </p>
      `,
  ...
  },
  {
    ...
    love heavy metal drums, James.<br>
    ...
    tightened to change the pitch.<br>
    ...
    tightens the string and raises the pitch.<br>
  ...
  },
  {
    ...
    text: `
    <p>The latest blockbuster movie Robots Attack
    ...
    evil robots easily.</p>
    <p>Of course, our leading man saves a lady in
    ...
    make him return to his evil ways.</p>
    <p>Does Andy Robot succeed in rescuing
  ...
  },
  {
    ...
    text: `
    <p>It happens a lot. So many people visit and
    ...
    another culture, it is rude.</p>
    <p>For example, my friend visited a relative in
    ...
    all of the dishes, but not in Israel.</p>
    <p>Something similar happened to me when I
    ...
    course, I apologized for my mistake.</p>
    <p>A faux pas is embarrassing. No one wants to
  ...
  },
  {
    ...
    day of school is just next week!<br>
    M: Your mother and I are proud of you. Greer is a
    very prestigious art school.<br>
    G : There is an enormous list of art supplies. They
    are mostly items I don’t recognize.<br>
    M: Let’s look for the supplies that you recognize,
    Megan, and then we can get help with the rest.<br>
    ...
    pencils over there. What’s next?<br>
    G : I need watercolor paint, various brushes, India
    ink, and a fountain pen.<br>
    ...
    what that is, and where we can find it?<br>
    ...
    erase, so we keep it next to the erasers.<br>
    G : That’s everything, Dad!<br>
    M: Great! Let’s pay for all these supplies<br>
      `,
  ...
  },
  {
    ...
    text: `
    <p>There are many popular leisure time activities,
    ...
    activity is probably camping.</p>
    <p>Many families like camping. It is a chance for
    ...
    biggest fish? It’s a great contest.</p>
    <p>Later, the children clean the fish by the river.
  ...
  },
  {
    ...
    you a pizza with whatever toppings you want.<br>
    W: Do you really mean any topping, even mushrooms,
    which you don’t like?<br>
    ...
    let’s get some lunch.<br>
    W: I want to try this new restaurant called Skylight.
    The top of the restaurant spins while you eat!<br>
    M: Oh, wow! Let’s go!
      `,
  ...
  },
  {
    ...
    make good money with our lemonade stand.<br>
  ...
  },
  {
    ...
    want to see this movie on the big screen.<br>
    ...
    I know you are on a restricted budget.<br>
    ...
    W: No, I think there is enough sugar in the brownies.<br>
  ...
  },
  {
    ...
    text: `
    <p>When someone does an activity that is not a
    ...
    experience.</p>
    <p>Creative hobbies are popular. Some creative
    ...
    become writers or artists when they retire.</p>
    <p>Collecting is also popular. Most collectors used
    ...
    online in stores all around the world.</p>
    <p>Enjoying an experience is a hobby, too. Some
    ...
    also tutor children or help the elderly.</p>
    <p>A hobby is something that is done for fun.
  ...
  },
  {
    ...
    your left foot. How are you feeling?<br>
  ...
  },
  {
    ...
    report, and I can’t get started.<br>
    ...
    learn to write well. I know you can do it.<br>
    ...
    can you tell me about the book?<br>
  ...
  },
  {
    ...
    help each other with assignments.<br>
    ...
    an “A” or a “B.” And there is no homework.<br>
  ...
  },
  {
    ...
    text: `
    <p>Thanksgiving is a special family holiday in
    ...
    Thanksgiving, too.</p>
    <p>Everyone in my family goes to my parents’
    ...
    cook.</p>
    <p>When it is time to eat, we put all the food on
    ...
    <p>There is a lot of activity after the meal. My
    ...
    Most of all, we are thankful to have each othe</p>
      `,
  ...
  },
  {
    ...
    school, and I really don’t know where to begin.<br>
    ...
    one day. What’s this project about?<br>
    ...
    one that I am always happy to talk about.<br>
    ...
    give David Chang a call right now and find out.<br>
  ...
  },
  {
    ...
    does he do at the fire station?<br>
    ...
    My dad loves to drive the fire trucks.<br>
  ...
  },
  {
    ...
    text: `
    <p>Ferren Lee’s mother hoped her daughter would
    follow in her footsteps and become a doctor.
    However, Ferren always knew she wanted to
    sing.</p>
    <p>In her spare time, Ferren sang along with
    ...
    Sony.</p>
    <p>Today, CoCo Lee, as she is now known, is
    ...
    <p>Apart from her beautiful voice and stunning
    ...
    cure for cancer.</p>
    <p>Who knows? CoCo’s mother may yet get her
    wish.</p>
      `,
  ...
  },
  {
    ...
    Madrid for the concert.<br>
    W: Why didn’t you say something? No wonder your
    playing sounded so bad. Oh dear, I’m really sorry.<br>
  ...
  },
  {
    ...
    text: `
    <p>Have you ever thought about committing a
    ...
    painting from a big museum?</p>
    <p>There are many stories in movies and on TV
    ...
    who fail. These crooks soon regret their crimes.</p>
    <p>Take the example of a man in Winnipeg who
    ...
    good car stereos.</p>
    <p>However, he did not know that he was being
    ...
    like this man shows us that crime does not pay.</p>
      `,
  ...
  },
  {
    ...
    chance to be part of your company.<br>
  ...
  },
  {
    ...
    of doctors around here. Why are you going?<br>
  ...
  },
  {
    ...
    text: `
    <p>Everyone wants to be healthy. People see
    ...
    “herbal medicine.”</p>
    <p>There are many plants used in herbal medicine.
    ...
    can stop bad breath.</p>
    <p>Herbs may be gentler than some pills.
    ...
    flower. It also has poison in it.</p>
    <p>Nevertheless, if you are afraid of using herbs,
  ...
  },
  {
    ...
    text: `
    <p>Everyone gets a cold now and then. Doctors
    ...
    They have changed very little over time.</p>
    <p>Different cultures use different ingredients.
    ...
    Some honey can be added after it is done.</p>
    <p>Each family usually has a home remedy for
  ...
  },
  {
    ...
    text: `
    <p>Soccer is one of the most popular sports in
    the world. Although the main idea of the game
    is easy to understand, there are many rules to be
    followed.</p>
    <p>A player gets a yellow card for not following
    ...
    is ejected from the game.</p>
    <p>Another rule is about “handling.” “Handling”
    ...
    legs to get the ball.</p>
    <p>There are also some lesser-known rules. A
  ...
  },
  {
    ...
    text: `
    <p>Frisco City is the place for your next vacation.
    The city has lots of shopping, food, and fun. There
    are so many things to do!</p>
    <p>The River Walk is a must-see. Take a city bus
    ...
    Walk.</p>
    <p>However, the River Walk is only one of the
    ...
    roller coasters and other rides at Sun Land.</p>
    <p>Visit Frisco City! You will have a great time.</p>
      `,
  ...
  },
  {
    ...
    text: `
    <p>Asking for directions can be risky. I realized
    exactly how risky it could be when I needed to
    meet one of my friends one day.</p>
    <p>A while ago, I arranged to meet my friend at
    ...
    Palace in the mall.</p>
    <p>When I arrived at the mall, I realized I did not
    ...
    just in time.</p>
    <p>Twenty minutes later, I was beginning to
    ...
    in the mall.</p>
    <p>Since then, I have made sure that I get the
    directions from my friends before I go to meet
    them. It saves me a lot of trouble!</p>
      `,
  ...
  },
  {
    ...
    text: `
    <p>When your car gets a flat tire, do not panic.
    First, apply your brakes and pull over. Inside
    the trunk, you will find a spare tire and a toolbox. </p>
    <p>AOne of these tools is a jack, which is a tool
    ...
    Reposition the jack and begin again.</p>
    <p>Next, use a crowbar to pry off the hubcap
    ...
    turn. It may be difficult.</p>
    <p>Once the bolts are loose, the flat tire can be
    ...
    back in the trunk.</p>
    <p>Finally, drive to the nearest service station
    and get your flat tire fixed!</p>
      `,
  ...
  },
  {
    ...
    there.</p>
    <p>There is a place in Canada where you can
    ...
    They show how the people lived.</p>
    <p>The gift shop in the Visitors’ Center sells
    ...
    traditional bread. All of the food is tasty.</p>
    <p>The archeology lab is run by the local university.
    A big window lets you see the archeologists working.
    They found a very old spearhead. They also
    found ancient human bones.</p>
    <p>The First Nations Visitors’ Center is a great
    place. You can learn about the First Nations’ culture.
    You can also see archeologists at work. You can
    walk on the trails, or enjoy a trad</p>
      `,
